...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
  <ul class="nav flex-column nav-pills" id="myTab" role="tablist" aria-orientation="vertical">
    ...
    <li> <a class="nav-link" @click="ChangeTitle('Mensajes'), MensajesLeidos()" id="v-pills-mensajes-tab"    data-toggle="tab" href="#mensajes" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fas fa-envelope"></i> Mensajes <span v-if="CantidadMsg > 0" class="right badge badge-danger">{{CantidadMsg}} New</span></a>  </li>
